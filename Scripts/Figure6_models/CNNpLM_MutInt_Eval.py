...
checkpoint  = torch.load("mutint.nature.trained.1dCNN.pth")
...
model = ilmCNN(11,248,2,119,7,0.28493)
...
def main():
	...
	labels = list(data["Y2H_score"])

	labels = torch.tensor(labels)

	eval(indexed,labels,batch_size,"mutint")
